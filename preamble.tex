...
% for Ponetium
%\usepackage{textpos}
%\newcommand{\sticker}[4]{\begin{minipage}{#1}\begin{textblock}{0}(-0.29,-0.2)\textcolor{gray!50!black}{\LARGE +}\end{textblock}\centering\color{magenta!75!white}#2\\[0.75ex]\includegraphics[width=#1]{#4}\\#3\end{minipage}}
