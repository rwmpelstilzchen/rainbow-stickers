...
\newcommand{\sticker}[4]{\begin{minipage}{#1}\centering\color{magenta}#2\\[0.75ex]\includegraphics[width=#1]{#4}\\#3\end{minipage}}
...
\newcommand{\hl}[1]{\textcolor{magenta!75!white}{\textbf{#1}}}
